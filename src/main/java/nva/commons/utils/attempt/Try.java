...
public abstract class Try<T> {
    ...
    /**
     *  A wrapper for actions that throw checked Excetions. See {@see https://www.oreilly.com/content/handling-checked-exceptions-in-java-streams/}
    ...
    /**
     *  A wrapper for functions that throw checked Excetions. See {@see https://www.oreilly.com/content/handling-checked-exceptions-in-java-streams/}
     *  Try to perform the action. Any exception will be enclosed in a Failure.
