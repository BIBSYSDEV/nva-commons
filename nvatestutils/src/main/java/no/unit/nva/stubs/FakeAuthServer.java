...
public class FakeAuthServer {
  ...
  public String createHttpInteractions(
      String clientId,
      String clientSecret,
  ...
  public String createResponseForProtectedContent(
      String expectedAccessToken, String exampleResourcePath) {
    var protectedContent = randomString();
    stubFor(
        get(exampleResourcePath)
  ...
  public void createOAuthAccessTokenResponse(
      String clientId, String clientSecret, String expectedAccessToken) {
  ...
  private ResponseDefinitionBuilder createForbiddenResponse() {
    return aResponse().withStatus(HTTP_FORBIDDEN).withBody(FORBIDDEN_BODY);
  }

  private ResponseDefinitionBuilder createOauthClientResponse(String body, int statusCode) {
    return aResponse().withStatus(statusCode).withBody(body);
  }

  private ResponseDefinitionBuilder createUserInfoResponse(String accessToken) {
    return aResponse().withBody(userInfoString(accessToken)).withStatus(HTTP_OK);
  }
