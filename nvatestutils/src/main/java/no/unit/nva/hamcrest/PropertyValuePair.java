...
public class PropertyValuePair {
  ...
  public static PropertyValuePair collectionElement(
      String propertyName, Object value, String parentPath, int index) {
  ...
  public List<PropertyValuePair> children() {
    ...
    return properties.stream().map(this::extractFieldValue).toList();
  }
  ...
  public List<PropertyValuePair> createPropertyValuePairsForEachCollectionItem() {
    ...
    while (iterator.hasNext()) {
      ...
      PropertyValuePair newElement =
          collectionElement(getPropertyName(), currentValue, parentPath, index);
  ...
  private boolean classShouldBeChecked(Set<Class<?>> stopRecursionClasses) {
    return stopRecursionClasses.stream()
