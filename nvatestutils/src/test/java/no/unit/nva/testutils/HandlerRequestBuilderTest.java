...
class HandlerRequestBuilderTest {
  ...
  void buildReturnsEmptyRequestOnNoArguments() throws Exception {
    InputStream request = new HandlerRequestBuilder<String>(objectMapper).build();
  ...
  void buildReturnsRequestWithBodyWhenStringInput() throws Exception {
    InputStream request = new HandlerRequestBuilder<String>(objectMapper).withBody(VALUE).build();
  ...
  void buildReturnsRequestWithHeadersWhenWithHeaders() throws Exception {
    InputStream request =
        new HandlerRequestBuilder<String>(objectMapper).withHeaders(Map.of(KEY, VALUE)).build();
  ...
  void buildReturnsRequestWithQueryParametersWhenWithQueryParameters() throws Exception {
    InputStream request =
        new HandlerRequestBuilder<String>(objectMapper)
  ...
  void buildReturnsRequestWithRequestContextWhenWithRequestContext() throws Exception {
    ...
    InputStream request =
        new HandlerRequestBuilder<String>(objectMapper).withRequestContext(requestContext).build();
  ...
  void buildReturnsRequestWithRequestContextWithUserNameClaimWhenWithNvaUserClaim()
    ...
    InputStream requestStream =
        new HandlerRequestBuilder<String>(objectMapper).withUserName(expectedUsername).build();
  ...
  @Test
  void buildReturnsPersonsFeideIdWhenSet()
      throws JsonProcessingException, ApiIoException, UnauthorizedException {
    var expectedFeideId = randomString();
    var request =
        new HandlerRequestBuilder<String>(objectMapper).withFeideId(expectedFeideId).build();
  ...
  void buildReturnsRequestWithMethodWhenWithMethod() throws Exception {
    InputStream request =
        new HandlerRequestBuilder<String>(objectMapper).withHttpMethod(SOME_METHOD).build();
  ...
  void shouldInsertPersonsNinWhenSet() throws JsonProcessingException {
    ...
    var request =
        new HandlerRequestBuilder<String>(objectMapper).withPersonNin(expectedPersonNin).build();
