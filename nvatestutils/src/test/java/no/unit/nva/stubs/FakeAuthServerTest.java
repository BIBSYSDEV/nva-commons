...
class FakeAuthServerTest {
  ...
  @Test
  void shouldReturnUserInfoWhenReceivingGetUserInfoRequestWithAccessToken()
  ...
  @Test
  void shouldReturnProtectedResourceWhenAccessWithValidAccessToken()
      throws IOException, InterruptedException {
    ...
    var protectedResource =
        authServer.createHttpInteractions(clientId, clientSecret, accessToken, exampleResourcePath);
    var requestUri =
  ...
  @Test
  void shouldNotReturnProtectedResourceWhenAccessingWithInvalidAccessToken()
      throws IOException, InterruptedException {
    var clientId = randomString();
    var clientSecret = randomString();
    var exampleResourcePath = "/example";
