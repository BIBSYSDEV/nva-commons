...
/**
 * Abstract class for implementing a Request Authorizer. Implementation is based on the AWS examples
 * found in the following page :
 * "https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-use-lambda-authorizer
 * .html".
 */
public abstract class RequestAuthorizer
  ...
  /**
   * This method can be overridden to change the template of the accessed resource. The resource
   * that access will be allowed to. It can contain wildcards.
   *
   * <p>Example methodARN:
   * arn:aws:execute-api:eu-west-1:884807050265:2lcqynkwke/Prod/GET/some/path/to/resource Example
   * output: arn:aws:execute-api:eu-west-1:884807050265:2lcqynkwke/Prod\/*\/*
   *
   * <p>Another possible output is: "*"
   *
