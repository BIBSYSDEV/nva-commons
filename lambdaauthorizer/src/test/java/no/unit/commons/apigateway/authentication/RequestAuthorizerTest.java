...
public class RequestAuthorizerTest {
  ...
  public static final String DEFAULT_METHOD_ARN =
      "arn:aws:execute-api:eu-west-1:884807050265:2lcqynkwke/Prod/GET"
          + "/service/users/orestis@unit.no";
  public static final String EXPECTED_RESOURCE =
  ...
  void authorizerThrowsExceptionWhenFetchingPrincipalExceptionThrowsExceptionInFailureResponse() {
    ...
    assertThat(
        ...
        containsString(RequestAuthorizer.COULD_NOT_READ_PRINCIPAL_ID_ERROR));
  }
  ...
  private APIGatewayCustomAuthorizerEvent requestWithoutApiKey() {
    return APIGatewayCustomAuthorizerEvent.builder().withMethodArn(DEFAULT_METHOD_ARN).build();
  }
