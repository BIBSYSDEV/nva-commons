...
public final class LogUtils {
  ...
  private static <T> void addLoggerForTheInputClass(
      Class<T> clazz, ConfigurationBuilder<BuiltConfiguration> builder) {
  ...
  private static AppenderComponentBuilder addTestAppenderToConfig(
    ...
    AppenderComponentBuilder appenderBuilder =
        builder.newAppender(TestAppender.APPENDER_NAME, TestAppender.PLUGIN_NAME);
  ...
  private static ConfigurationBuilder<BuiltConfiguration>
      avoidStatusMessagesWhileSettingUpConfiguration(
          ConfigurationBuilder<BuiltConfiguration> builder) {
