...
public class SecretsWriter {
  ...
  private PutSecretValueResponse upsertValueResponse(
      GetSecretValueResponse secretValueResponse, String secretKey, String secretValue) {
  ...
  public <T> String toJsonCompact(T toJsonObject) {
    return attempt(
            () -> objectMapper.writer(getPrettyPrinterCompact()).writeValueAsString(toJsonObject))
        .orElseThrow();
  }
