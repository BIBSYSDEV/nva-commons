...
/**
 * When sending HTTP requests, applying a User-Agent header allows the recipient to know who is
...
public final class UserAgent {
  ...
  public static final class UserAgentBuilder {
    ...
    /**
     * The contact email (typically support@somewhere) that recipients can contact in case of an
     * issue.
     *
    ...
    public UserAgent build() {
      ...
      var userAgentString =
          String.format(
              USER_AGENT_TEMPLATE, clientName, environmentName, versionName, uri, emailAddress);
