...
public final class JsonUtils {
    ...
    public static final ObjectMapper dtoObjectMapper = createJsonParser(Include.ALWAYS, PRETTY_JSON);
    public static final ObjectMapper dynamoObjectMapper = createJsonParser(Include.NON_EMPTY, PRETTY_JSON);
    public static final ObjectMapper singleLineObjectMapper = createJsonParser(Include.NON_EMPTY,
                                                                               JSON_IN_SINGLE_LINE);
