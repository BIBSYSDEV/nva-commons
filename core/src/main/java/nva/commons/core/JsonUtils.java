...
public final class JsonUtils {
    ...
    public static final ObjectMapper objectMapperNoNAbsent = createJsonParser(Include.NON_ABSENT);
    public static final ObjectMapper objectMapperWithEmpty = createJsonParser(Include.ALWAYS);

    public static final ObjectMapper objectMapper = objectMapperNoNAbsent;
