...
public class StringUtilsTest {
  ...
  private static final String PARAMETERIZED_TEST_NAME_FORMAT =
      "[{index}]  {displayName} with input: \"{0}\"";
  ...
  void shouldRemoveXmlTagsFromString() {
    var string =
        "Territorial expansion of the European Ips species in the 20<sup>th</sup> century - a"
            + " review";
  ...
  static Stream<String> blankStrings() {
    return Stream.of(
        EMPTY_STRING, BLANK_STRING, TAB_STRING, CARRIAGE_RETURN, LINE_FEED, END_OF_LINE, NULL);
  }
}
