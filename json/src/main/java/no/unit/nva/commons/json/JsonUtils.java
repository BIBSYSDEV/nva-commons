...
public final class JsonUtils {
  ...
  public static final ObjectMapper dtoObjectMapper =
      createJsonParser(Include.NON_ABSENT, PRETTY_JSON);
  public static final ObjectMapper dynamoObjectMapper =
      createJsonParser(Include.NON_EMPTY, PRETTY_JSON);
  private static final boolean JSON_IN_SINGLE_LINE = false;
  public static final ObjectMapper singleLineObjectMapper =
      createJsonParser(Include.NON_EMPTY, JSON_IN_SINGLE_LINE);

  private JsonUtils() {}

  private static ObjectMapper createJsonParser(
      JsonInclude.Include includeEmptyValuesOption, boolean prettyJson) {
    JsonFactory jsonFactory = new JsonFactory().configure(Feature.ALLOW_SINGLE_QUOTES, true);
