 ...
 * events.
 */
public abstract class AbstractScanDatabaseRequest<T> implements EventBody, JsonSerializable {
    ...
    private final Map<String, T> startMarker;
    ...
    @JsonCreator
    public AbstractScanDatabaseRequest(
        @JsonProperty(TOPIC) String topic,
        @JsonProperty(PAGE_SIZE) Integer pageSize,
        @JsonProperty(START_MARKER) Map<String, T> startMarker) {
    ...
    @JacocoGenerated
    public Map<String, T> getStartMarker() {
        return startMarker;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AbstractScanDatabaseRequest)) {
            return false;
        }
        AbstractScanDatabaseRequest<?> that = (AbstractScanDatabaseRequest<?>) o;
