...
public abstract class DestinationsEventBridgeEventHandler<I, O>
  ...
  @Override
  protected final O processInput(
      AwsEventBridgeDetail<I> input,
  ...
  protected abstract O processInputPayload(
      I input, AwsEventBridgeEvent<AwsEventBridgeDetail<I>> event, Context context);
}
