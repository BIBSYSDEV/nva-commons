...
class AwsEventBridgeDetailTest {
  ...
  private static final String SAMPLE_EVENT_DETAIL =
      IoUtils.stringFromResources(Path.of("validEventBridgeDetailSample.json"));
  ...
  private AwsEventBridgeDetail<SampleEventDetail> parseSampleEventDetail()
    ...
    TypeReference<AwsEventBridgeDetail<SampleEventDetail>> detailTypeReference =
        new TypeReference<>() {};
