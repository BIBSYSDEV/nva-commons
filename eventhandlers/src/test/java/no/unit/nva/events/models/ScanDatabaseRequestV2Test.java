...
class ScanDatabaseRequestV2Test {
  ...
  @Test
  void shouldReturnAnEventBridgeEventWhereTheTopicIsSetInTheDetailBody()
  ...
  void shouldReturnScanRequestFromEventDetail() {
    ...
    var reconstructedRequest = ScanDatabaseRequestV2.fromJson(event.detail());
  ...
  @ParameterizedTest(
      name = "should set default page size when page size is off limits.Page size:{0}")
  ...
  void shouldSetDefaultPageSizeWhenRequestedPageSizeIsOfLimits(int pageSize) {
    ...
    var actualRequest = new ScanDatabaseRequestV2(expectedTopic, pageSize, expectedStartMarker);
    var expectedRequest =
        new ScanDatabaseRequestV2(expectedTopic, DEFAULT_PAGE_SIZE, expectedStartMarker);
