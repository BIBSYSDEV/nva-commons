...
public class EventHandlerTest extends AbstractEventHandlerTest {
  ...
  public void handleRequestReThrowsExceptionWhenExceptionIsThrown() {
    ...
    Executable action =
        () ->
            handler.handleRequest(sampleInputStream(AWS_EVENT_BRIDGE_EVENT), outputStream, context);
  ...
  private ObjectNode sendEventAndCollectOutputAsJsonObject(
      InputStream input, EventHandlerTestClass handler) throws JsonProcessingException {
    handler.handleRequest(input, outputStream, context);
  ...
  private static class EventHandlerTestClass
      extends EventHandler<SampleEventDetail, SampleEventDetail> {

    private final AtomicReference<AwsEventBridgeEvent<SampleEventDetail>> eventBuffer =
        new AtomicReference<>();
    ...
    @Override
    protected SampleEventDetail processInput(
        SampleEventDetail input, AwsEventBridgeEvent<SampleEventDetail> event, Context context) {
