package  nva.commons.doi.publication;

import static  nva.commons.doi.publication.Doi.DEFAULT_DOI_PROXY;
import static  nva.commons.doi.publication.Doi.PATH_SEPARATOR;
import static  nva.commons.doi.publication.Doi.PATH_SEPARATOR_STRING;
import static  nva.commons.doi.publication.Doi.SCHEMA_SEPARATOR;
import static  nva.commons.doi.publication.Doi.VALID_PROXIES;
import static  nva.commons.doi.publication.Doi.VALID_SCHEMES;
import static  nva.commons.doi.publication.ImmutableDoi.CANNOT_BUILD_DOI_DOI_PREFIX_IS_NOT_VALID;
import static  nva.commons.doi.publication.ImmutableDoi.CANNOT_BUILD_DOI_PROXY_IS_NOT_A_VALID_PROXY;
import static  nva.commons.doi.publication.ImmutableDoi.ERROR_DOI_URI_INVALID_FORMAT;
